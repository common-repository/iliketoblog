...
class ILTBXMLParser 
{
    ...
    */
     ...
     * @return XMLParser
     */
    function ILTBXMLParser($xml = '', $cleanTagNames = true)
    {
        //Load XML document
        $this->xml = $xml;
    ...
    function StartElement($parser, $name, $attrs = array())
    {
        ...
        if (count($this->stack) == 0) 
        {
            ...
            $this->document = new ILTBXMLTag($name, $attrs);
...
class ILTBXMLTag
{
     ...
     * @return XMLTag
     */
    function ILTBXMLTag($name, $attrs = array(), $parents = 0)
    {
    ...
    {    
        ...
        $child = new ILTBXMLTag($name, $attrs, $parents);
